 ...
 */
#ifdef USE_BOARD_SENSORNODE_R1
#ifndef BOARD_SENSORNODE_R1
#define BOARD_SENSORNODE_R1
 ...
 */
#define HAL_BOARD "Sensornode r1"
 ...
 */
#define ADC_MAP { &hadc1, &hadc1, &hadc2, &hadc2}

/**
 * Defines the mapping of the logical ADC channels to the physical ADC channels.
 * Count of channels MUST be equal to ADC_CHANNEL_COUNT.
 */
#define ADC_MAP_CHANNELS { ADC_CHANNEL_0, ADC_CHANNEL_1, ADC_CHANNEL_2, ADC_CHANNEL_3 }
 ...
 */
#define DIGITAL_MAP_PERIPHERAL { GPIOC, GPIOA, GPIOA, GPIOB, GPIOB, GPIOB, GPIOB, GPIOB, GPIOB, GPIOB, GPIOB, GPIOB, GPIOB, GPIOA }

/**
 * Defines the mapping of the logical digital channels to the physical digital channel.
 * Count of channels MUST be equal to DIGITAL_CHANNEL_COUNT.
 */
#define DIGITAL_MAP_CHANNEL { GPIO_PIN_13, GPIO_PIN_8, GPIO_PIN_9, GPIO_PIN_0, GPIO_PIN_1, GPIO_PIN_4, GPIO_PIN_5, GPIO_PIN_10, GPIO_PIN_11, GPIO_PIN_12, GPIO_PIN_13, GPIO_PIN_14, GPIO_PIN_15, GPIO_PIN_4 }
...
#define DIGITAL_PB0 3
#define DIGITAL_PB1 4
#define DIGITAL_PB4 5
#define DIGITAL_PB5 6
#define DIGITAL_PB10 7
#define DIGITAL_PB11 8
#define DIGITAL_PB12 9
#define DIGITAL_PB13 10
#define DIGITAL_PB14 11
#define DIGITAL_PB15 12
#define DIGITAL_PA4 13
...
//Define drain pins
#define DRAIN_ENABLE_PIN_1 DIGITAL_PB0
#define DRAIN_ENABLE_PIN_2 DIGITAL_PB1
#define DRAIN_ENABLE_PIN_3 DIGITAL_PB10
#define DRAIN_ENABLE_PIN_4 DIGITAL_PB11
